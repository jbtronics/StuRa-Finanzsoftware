 ...
 */
final class Version20200618193948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment_orders CHANGE department_id department_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment_orders CHANGE department_id department_id INT DEFAULT NULL');
    }
}
