...
class PaymentOrderFixture extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $payment_order->getBankInfo()->setIban("DE98 5001 0517 4783 9248 44");
        $payment_order->getBankInfo()->setStreet("Street 1");
        $payment_order->getBankInfo()->setZipCode("12345");
        $payment_order->getBankInfo()->setCity("Jena");
        ...
        $payment_order->setComment("Test");
        $payment_order->getBankInfo()->setAccountOwner("John Doe");
        $payment_order->getBankInfo()->setIban("DE98500105174783924844");
        $payment_order->getBankInfo()->setBic("INGDDEFFXXX");
        $payment_order->getBankInfo()->setStreet("Street 1");
        $payment_order->getBankInfo()->setZipCode("12345");
        $payment_order->getBankInfo()->setCity("Jena");
        $manager->persist($payment_order);
